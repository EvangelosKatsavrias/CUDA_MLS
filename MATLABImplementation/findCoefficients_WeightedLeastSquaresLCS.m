function [coefficients, conditionNumber] = findCoefficients_WeightedLeastSquaresLCS(samplePoints, stationaryPoints, sampleValues, polynomial, solver, condNumEvaluator, weightPerStationaryPoint)
